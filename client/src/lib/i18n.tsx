...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    "home.hero.sub": "شريكك في التحول الرقمي عبر التدريب على الذكاء الاصطناعي والتسويق الرقمي وبرمجيات الأعمال — مصمَّمة كنظام واحد متكامل تملكه بالكامل، لا كثلاث خدمات منفصلة.",
