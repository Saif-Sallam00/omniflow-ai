...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "systemMap.aria": "A connected business system: AI training, digital marketing, software, automation, CRM and strategy all connecting into one central system.",

    // --- HOME ---
    "home.hero.h1.lead": "Most teams buy the tool first.",
    "home.hero.h1.highlight": "We diagnose first.",
    "home.hero.sub": "AI, marketing, software, automation — we only build what the diagnosis supports. We look before we touch, so what we build fits how your business actually runs.",
    ...
    "home.reach.countries": "Egypt · Saudi Arabia · UAE · Qatar · Kuwait · Bahrain · Oman · United States",
  ...
  ar: {
    ...
    "systemMap.aria": "نظام أعمال مترابط: التدريب على الذكاء الاصطناعي، والتسويق الرقمي، والبرمجيات، والأتمتة، وإدارة العملاء، والاستراتيجية، تترابط جميعها في نظام مركزي واحد.",

    // --- HOME ---
    "home.hero.h1.lead": "معظم الفِرق تبدأ باختيار الأداة.",
    "home.hero.h1.highlight": "نحن نبدأ بالتشخيص.",
    "home.hero.sub": "ذكاء اصطناعي، تسويق، برمجيات، أتمتة — لا نبني إلا ما يدعمه التشخيص. ننظر قبل أن نلمس، ليلائم ما نبنيه طريقة عمل أعمالك فعلاً.",
    "home.hero.cta2": "استعرض أعمالنا",
    "home.trustEyebrow": "شركاء نثق بهم",
    "home.trust": "تثق بنا فرقٌ تبني مستقبل قطاعاتها.",
    "home.reach.headline": "موثوقون من علاماتٍ تجارية في الولايات المتحدة ودول الخليج ومصر",
    "home.reach.stat1.value": "50+",
    ...
    "home.reach.countries": "مصر · السعودية · الإمارات · قطر · الكويت · البحرين · عُمان · الولايات المتحدة",
