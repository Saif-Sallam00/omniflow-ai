...
const buttonVariants = cva(
  // Radius by role: utility/secondary buttons default to rounded-lg here; pill
  // CTAs, chips and icon buttons opt into rounded-full at the call site. Hover is
  // the restrained shadcn overlay (hover-elevate) — no scale/bounce.
